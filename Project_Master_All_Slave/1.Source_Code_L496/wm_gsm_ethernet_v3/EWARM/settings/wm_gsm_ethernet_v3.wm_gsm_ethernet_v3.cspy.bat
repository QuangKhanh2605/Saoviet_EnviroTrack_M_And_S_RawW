...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.3\common\bin\cspybat" -f "D:\Project_STM32\Project_Test_Datalogger\Project_Master_Clean_Water\1.Source_Code_L496\wm_gsm_ethernet_v3\EWARM\settings\wm_gsm_ethernet_v3.wm_gsm_ethernet_v3.general.xcl" "--debug_file=%~1" --backend -f "D:\Project_STM32\Project_Test_Datalogger\Project_Master_Clean_Water\1.Source_Code_L496\wm_gsm_ethernet_v3\EWARM\settings\wm_gsm_ethernet_v3.wm_gsm_ethernet_v3.driver.xcl" 
