...
//    {   __SC1_ID_DCU,       NULL,               NULL,   _DTYPE_STRING,   0,      NULL,      2,  20, 0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_CLO_DU,       "CLO  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_PH_WATER,     "PH   : ",         NULL,   _DTYPE_I16,        0,   "  pH",     2,  0,  0x00,    _LCD_SCREEN_CM44    },
    ...
    {   __SC1_SALINITY,     "Salt : ",         NULL,   _DTYPE_I16,        0,   "  %",      2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_COD,          "COD  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_TSS,          "TSS  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_NH4,          "NH4  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_DO,           "DO   : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_TDS,          "TDS  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_NO3,          "NO3  : ",         NULL,   _DTYPE_I16,        0,   "  mg/L",   2,  0,  0x00,    _LCD_SCREEN_CM44    },
    ...
    {   __SET_OPTION_SENSOR,"2.Option Sensor",  NULL,   _DTYPE_STRING,   0,      NULL,      3,  14, 0x00,    _LCD_SCR_SETTING },
...
{
    { __SC1_CLO_DU,     &s485Measure[_SS_CLO].sUser,      &sDataSensorMeasure.sClo.State_u8},
    { __SC1_PH_WATER,   &s485Measure[_SS_PH].sUser,       &sDataSensorMeasure.spH.State_u8},
    { __SC1_TURB,       &s485Measure[_SS_TURB].sUser,     &sDataSensorMeasure.sTurb.State_u8},
    { __SC1_EC,         &s485Measure[_SS_EC].sUser,       &sDataSensorMeasure.sEC.State_u8},
    { __SC1_SALINITY,   &s485Measure[_SS_SALT].sUser,     &sDataSensorMeasure.sSal.State_u8},
    { __SC1_COD,        &s485Measure[_SS_COD].sUser,      &sDataSensorMeasure.sCOD.State_u8},
    { __SC1_TSS,        &s485Measure[_SS_TSS].sUser,      &sDataSensorMeasure.sTSS.State_u8},
    { __SC1_NH4,        &s485Measure[_SS_NH4].sUser,      &sDataSensorMeasure.sNH4.State_u8},
    { __SC1_DO,         &s485Measure[_SS_DO].sUser,       &sDataSensorMeasure.sDO.State_u8},
    { __SC1_TDS,        &s485Measure[_SS_TDS].sUser,      &sDataSensorMeasure.sTDS.State_u8},
    { __SC1_NO3,        &s485Measure[_SS_NO3].sUser,      &sDataSensorMeasure.sNO3.State_u8},
    
    { __SC1_TEMP,       NULL,                       &sDataSensorMeasure.sTemp.State_u8},
};
