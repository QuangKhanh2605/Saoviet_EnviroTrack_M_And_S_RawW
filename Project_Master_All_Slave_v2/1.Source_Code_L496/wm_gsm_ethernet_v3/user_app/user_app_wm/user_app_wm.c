...
void Handle_Data_CM44(uint32_t u32_Clo_Du, uint32_t u32_pH_Water, uint32_t u32_NTU, uint32_t u32_Salinity, uint32_t u32_Temp)
{
    ...
    sDataSensorMeasure.sClo.Value_i32 = (uint16_t)(f_Clo_Du*100);
    sDataSensorMeasure.spH.Value_i32 = (uint16_t)(f_pH_Water*100);
    sDataSensorMeasure.sTurb.Value_i32 = (uint16_t)(f_NTU*10);
    sDataSensorMeasure.sSal.Value_i32 = (uint16_t)(f_Salinity*100);
