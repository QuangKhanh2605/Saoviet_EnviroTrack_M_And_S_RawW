...
//    {   __SC1_ID_DCU,       NULL,               NULL,   _DTYPE_STRING,   0,      NULL,      2,  20, 0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_PH,           "PH   : ",         NULL,   _DTYPE_I32,        0,   " pH",     2,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_TSS,          "TSS  : ",         NULL,   _DTYPE_I32,        0,   " mg/L",   3,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_COD,          "COD  : ",         NULL,   _DTYPE_I32,        0,   " mg/L",   4,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_NH4,          "NH4  : ",         NULL,   _DTYPE_I32,        0,   " mg/L",   5,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_DO,           "DO   : ",         NULL,   _DTYPE_I32,        0,   " mg/L",   6,  0,  0x00,    _LCD_SCREEN_CM44    },
    {   __SC1_TEMP,         "Temp : ",         NULL,   _DTYPE_I32,        0,   " ‰C",     7,  0,  0x00,    _LCD_SCREEN_CM44    },
    //screen channel 1
    ...
    {   __SET_OFFSET_SS_CLO,        "2.COD : ",     NULL,   _DTYPE_I32,    0xFE,      " mg/L",      3,  0, 0x00,    _LCD_SCR_SET_OFFSET_SENSOR },
    {   __SET_OFFSET_SS_TURB,       "3.nh4: ",     NULL,   _DTYPE_I32,    0xFE,      " NTU",       4,  0, 0x00,    _LCD_SCR_SET_OFFSET_SENSOR },
    {   __SET_OFFSET_SS_EC,         "4.TSS  : ",     NULL,   _DTYPE_I32,    0xFE,      " uS/cm",     5,  0, 0x00,    _LCD_SCR_SET_OFFSET_SENSOR },
    ...
    {   __SET_OPTION_SS_COD,    "2.COD     : ",   NULL,   _DTYPE_U8,   0x00, NULL,            4,  14,  0x00,    _LCD_SCR_SET_OPTION_SENSOR  },
    {   __SET_OPTION_SS_TSS,    "3.TSS      : ",   NULL,   _DTYPE_U8,   0x00, NULL,            5,  14,  0x00,    _LCD_SCR_SET_OPTION_SENSOR  },
    {   __SET_OPTION_SS_NH4,    "4.TUR     : ",   NULL,   _DTYPE_U8,   0x00, NULL,            6,  14,  0x00,    _LCD_SCR_SET_OPTION_SENSOR  },
...
//    sLCDObject[__SC1_ID_DCU].pData      = sModemInfor.sId.Data_a8;
    ...
    sLCDObject[__SC1_PH].pData    = &sDataSensorMeasure.spH.Value_i32;    
    sLCDObject[__SC1_PH].Scale_u8 = sDataSensorMeasure.spH.Scale_u8;    
    ...
    sLCDObject[__SET_OFFSET_SS_CLO].pData       = &sParaDisplay.COD_Offset_i32;
    sLCDObject[__SET_OFFSET_SS_TURB].pData      = &sParaDisplay.NH4_Offset_i32;
    sLCDObject[__SET_OFFSET_SS_EC].pData        = &sParaDisplay.TSS_Offset_i32;
    sLCDObject[__SET_OFFSET_SS_SALINITY].pData  = &sParaDisplay.DO_Offset_i32;
    ...
    sLCDObject[__SET_OPTION_SS_COD].pData     = &sUserSensor.User_COD;
    sLCDObject[__SET_OPTION_SS_TSS].pData      = &sUserSensor.User_TSS;
    sLCDObject[__SET_OPTION_SS_NH4].pData   = &sUserSensor.User_NH4;
...
//          if(i == __SC1_CLO_DU && sUserSensor.User_COD == _INACTIVE_SENSOR)
//            continue;
//          
//          if(i == __SC1_PH_WATER && sUserSensor.User_pH == _INACTIVE_SENSOR)
//            continue;
//          
//          if(i == __SC1_TURB && sUserSensor.User_NH4 == _INACTIVE_SENSOR)
//            continue;
//          
//          if(i == __SC1_EC || i == __SC1_EC && sUserSensor.User_TSS == _INACTIVE_SENSOR)
//            continue;
...
//        {
            ...
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_PH].Row_u8, " ");
            }
            else
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_PH].Row_u8, "N");
            }
//        }
        
//        if(sUserSensor.User_COD == _ACTIVE_SENSOR)
//        {
            if(sDataSensorMeasure.sCOD.State_u8 == 0)
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_COD].Row_u8, " ");
            }
            else
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_COD].Row_u8, "N");
            }
//        }

//        if(sUserSensor.User_NH4 == _ACTIVE_SENSOR)
//        {
            if(sDataSensorMeasure.sNH4.State_u8 == 0)
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_NH4].Row_u8, " ");
            }
            else
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_NH4].Row_u8, "N");
            }
//        }
        
//        if(sUserSensor.User_TSS == _ACTIVE_SENSOR)
//        {
            if(sDataSensorMeasure.sTSS.State_u8 == 0)
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_TSS].Row_u8, " ");
            }
            else
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_TSS].Row_u8, "N");
            }
//        }
        
//        if(sUserSensor.User_DO == _ACTIVE_SENSOR)
//        {
            if(sDataSensorMeasure.sDO.State_u8 == 0)
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_DO].Row_u8, " ");
            }
            else
            {
                glcd_tiny_draw_string(120, sLCDObject[__SC1_DO].Row_u8, "N");
            }
//        }
...
void Display_Update_ScrSensor (uint8_t screen)
{
    if(screen == _LCD_SCREEN_CM44)
    {
        ...
        if(sUserSensor.User_COD == _ACTIVE_SENSOR)
            sLCDObject[__SC1_COD].Row_u8 = Row++;
        else
            sLCDObject[__SC1_COD].Row_u8 = Row;
        
        if(sUserSensor.User_pH == _ACTIVE_SENSOR)
            sLCDObject[__SC1_PH].Row_u8 = Row++;
        else
            sLCDObject[__SC1_PH].Row_u8 = Row;

        if(sUserSensor.User_NH4 == _ACTIVE_SENSOR)
            sLCDObject[__SC1_NH4].Row_u8 = Row++;
        else
            sLCDObject[__SC1_NH4].Row_u8 = Row;

        if(sUserSensor.User_TSS == _ACTIVE_SENSOR)
            sLCDObject[__SC1_TSS].Row_u8 = Row++;
        else
            sLCDObject[__SC1_TSS].Row_u8 = Row;
        
        if(sUserSensor.User_DO == _ACTIVE_SENSOR)
            sLCDObject[__SC1_DO].Row_u8 = Row++;
        else
            sLCDObject[__SC1_DO].Row_u8 = Row;
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.COD_Offset_i32 = (int32_t)(sOffsetMeasure.COD_f * 100);
    sParaDisplay.NH4_Offset_i32 = (int32_t)(sOffsetMeasure.NH4_f * 100);
    sParaDisplay.TSS_Offset_i32 = (int32_t)(sOffsetMeasure.TSS_f * 100);
    sParaDisplay.DO_Offset_i32 = (int32_t)(sOffsetMeasure.DO_f * 100);
