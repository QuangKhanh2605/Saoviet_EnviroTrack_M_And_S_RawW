...
//    AppCtrlOxy_Packet_Data(pData, &length, OBIS_STATE_PUMP_PH, &sParamCtrlPH.StateCtrl, 1, 0xAA);
        ...
        if(sDataSensorMeasure.sCOD.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_COD, &sDataSensorMeasure.sCOD.Value_i32, 2, sDataSensorMeasure.sCOD.Scale_u8);
        
        //----------  pH ------
        if(sDataSensorMeasure.spH.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_PH_WATER, &sDataSensorMeasure.spH.Value_i32, 2, sDataSensorMeasure.spH.Scale_u8);
        
        //----------  Do Duc------
        if(sDataSensorMeasure.sNH4.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_NH4, &sDataSensorMeasure.sNH4.Value_i32, 2, sDataSensorMeasure.sNH4.Scale_u8);
        
        //----------  SALINITY %------
        if(sDataSensorMeasure.sDO.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_OXY_MG_L, &sDataSensorMeasure.sDO.Value_i32, 2, sDataSensorMeasure.sDO.Scale_u8);
        
        //----------  Temperature ------
        if(sDataSensorMeasure.sTemp.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_OXY_TEMPERATURE, &sDataSensorMeasure.sTemp.Value_i32, 2, sDataSensorMeasure.sTemp.Scale_u8);
        
        //----------  EC ------
        if(sDataSensorMeasure.sTSS.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_TSS, &sDataSensorMeasure.sTSS.Value_i32, 2, sDataSensorMeasure.sTSS.Scale_u8);
...
//    }
//    
//    sDataSensorMeasure.sCOD.Value_i32 = (uint16_t)(f_Clo_Du*100);
//    sDataSensorMeasure.spH.Value_i32 = (uint16_t)(f_pH_Water*100);
//    sDataSensorMeasure.sNH4.Value_i32 = (uint16_t)(f_NTU*10);
//    sDataSensorMeasure.sDO.Value_i32 = (uint16_t)(f_Salinity*100);
//    sDataSensorMeasure.sTemp.Value_i32 = (uint16_t)(f_Temperature*100);
}
