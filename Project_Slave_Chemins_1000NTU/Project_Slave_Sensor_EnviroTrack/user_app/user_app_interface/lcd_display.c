...
sData   sModelVersion = {(uint8_t *) "SV_ENVI_CM_TURB1000", 19}; 
...
//          para          name                  value      dtype         scale   unit      row  col      screen
    {   __SC1_TITLE,      "TURB.",           NULL,   _DTYPE_STRING,   0,      NULL,      0,  0,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_TURB,        NULL,             NULL,   _DTYPE_I16,      0,     "NTU",      4,  0,  0x00,      _LCD_SCREEN_1  },
    ...
    {   __SET_TURB_TITLE,        "CALIB SENSOR",   NULL,   _DTYPE_STRING,   0,  NULL,       0,  0,  0x00,    _LCD_SCR_SET_CALIB_SS_TURB},
    {   __SET_TURB_VALUE,        "TURB: ",          NULL,   _DTYPE_I32,      0,  NULL,       2,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_TURB},
    {   __SET_TURB_CALIB_ZERO,   "1.Zero : ",      NULL,   _DTYPE_I32,      0,  " mg/L",     3,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_TURB},
    {   __SET_TURB_CALIB_SLOPE,  "2.Slope: ",      NULL,   _DTYPE_I32,      0,  " mg/L",     4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_TURB},
    {   __SET_TURB_RESET,        "3.Reset",        NULL,   _DTYPE_STRING,   0,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_TURB},
    
    {   __SET_OFFSET_TITLE, "OFFSET",          NULL,   _DTYPE_STRING,  0,      NULL,       0,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_TURB,   "1.TURB  : ",       NULL,   _DTYPE_I32,     0,   " mg/L",     2,  0, 0x00,    _LCD_SCR_SET_OFFSET},
    ...
    {   __SET_RANGE_U_KEY,        "1.U_Turb: ",      NULL,   _DTYPE_I32,  0,      " NTU",        2,  0, 0x00,    _LCD_SCR_SET_RANGE},
    {   __SET_RANGE_L_KEY,        "2.L_Turb: ",      NULL,   _DTYPE_I32,  0,      " NTU",        3,  0, 0x00,    _LCD_SCR_SET_RANGE},
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.TURB_Value_i32 = (int32_t)(sSensor_TURB.TURB_Value_f * Calculator_Scale(sParaDisplay.Scale_TURB));
    sParaDisplay.Temp_Value_i32 = (int32_t)(sSensor_TURB.temp_Value_f * Calculator_Scale(sParaDisplay.Scale_Temp));
    
    sParaDisplay.TURB_Filter_i32 = (int32_t)(sSensor_TURB.TURB_Filter_f * Calculator_Scale(sParaDisplay.Scale_TURB));
    sParaDisplay.Temp_Filter_i32 = (int32_t)(sSensor_TURB.temp_Filter_f * Calculator_Scale(sParaDisplay.Scale_Temp));
    
    sParaDisplay.TURB_Offset_i32   = (int32_t)(sSensor_TURB.TURB_Offset_f*Calculator_Scale(sParaDisplay.Scale_TURB));
    sParaDisplay.temp_Offset_i32 = (int32_t)(sSensor_TURB.temp_Offset_f * Calculator_Scale(sParaDisplay.Scale_Temp));
...
//    sParaDisplay.TURB_Calib_Zero_i32   = (int32_t)(sSensor_TURB.TURB_Zero_Calib_f * Calculator_Scale(sParaDisplay.Scale_TURB));
//    sParaDisplay.TURB_Calib_Slope_i32  = (int32_t)(sSensor_TURB.TURB_Slope_Calib_f * Calculator_Scale(sParaDisplay.Scale_TURB));
