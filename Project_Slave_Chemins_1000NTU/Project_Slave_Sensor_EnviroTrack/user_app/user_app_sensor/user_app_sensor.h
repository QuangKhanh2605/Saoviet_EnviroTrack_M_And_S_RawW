...
#define ID_DEFAULT_SS_TURB       0x07
...
#define ALARM_MIN               0
#define ALARM_MAX               TURB_RANGE_MAX

#define RANGE_KEY_MAX           TURB_RANGE_MAX
