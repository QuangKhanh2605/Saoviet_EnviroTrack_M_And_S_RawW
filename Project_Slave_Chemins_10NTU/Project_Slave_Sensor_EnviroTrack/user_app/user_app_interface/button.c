        ...
        case _LCD_SCR_SETTING:
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TURB, 0,
                                       __SET_TURB_CALIB_ZERO, __SET_TURB_CALIB_ZERO, __SET_TURB_RESET,
                                       NULL, 0xF1);
                    break;
            ...
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_TURB_CALIB_ZERO:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TURB, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_TURB_CALIB_ZERO, __SET_TURB_CALIB_ZERO, __SET_TURB_RESET,
                                               &sButton.Old_value, 0xF2);
                            sButton.Old_value = sParaDisplay.TURB_Value_i32;
                            break;
                ...
                case __SET_TURB_CALIB_SLOPE:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TURB, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_TURB_CALIB_SLOPE, __SET_TURB_CALIB_ZERO, __SET_TURB_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.TURB_Value_i32;
                            break;
                ...
                case __SET_TURB_RESET:
                    ...
                    RS485_LogData_Calib(_RS485_SS_TURB_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
            }
            break;
                    ...
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_TURB, __SET_OFFSET_TURB, __SET_OFFSET_TEMP,
                                               &sButton.Old_value, 0xF2);
                            sButton.Old_value = sParaDisplay.TURB_Offset_i32;
                            break;
                ...
                case __SET_OFFSET_TEMP:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_TEMP, __SET_OFFSET_TURB, __SET_OFFSET_TEMP,
                                               &sButton.Old_value,  0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_OFFSET:
                ...
                {
                    case __SET_OFFSET_TURB:
                      Save_ParamCalib(((float)sButton.Old_value/ Calculator_Scale(sParaDisplay.Scale_TURB)), sSensor_TURB.temp_Offset_f);
                      break;
                      
                    case __SET_OFFSET_TEMP:
                      Save_ParamCalib(sSensor_TURB.TURB_Offset_f, ((float)sButton.Old_value/ Calculator_Scale(sParaDisplay.Scale_Temp)));
                      break;
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    case __SET_TURB_CALIB_ZERO:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value < TURB_RANGE_MAX * Calculator_Scale(sParaDisplay.Scale_TURB)-10)
                                    sButton.Old_value+=10;
                                else
                                    sButton.Old_value = TURB_RANGE_MAX * Calculator_Scale(sParaDisplay.Scale_TURB);
                                break;
                ...
                case __SET_OFFSET_TURB:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8-1),
                                               __SET_OFFSET_TURB, __SET_OFFSET_TURB, __SET_OFFSET_TEMP,
                                               &sParaDisplay.TURB_Offset_i32, 0xF1);
                            break;
