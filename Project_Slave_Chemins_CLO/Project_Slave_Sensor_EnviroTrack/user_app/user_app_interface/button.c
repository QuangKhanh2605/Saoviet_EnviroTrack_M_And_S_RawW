    ...
    switch (sLCD.sScreenNow.Index_u8)
    {
            ...
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_CLO, 0,
                                       __SET_CLO_CALIB_ZERO, __SET_CLO_CALIB_ZERO, __SET_CLO_RESET,
                                       NULL, 0xF1);
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_CLO:
            switch (sLCD.sScreenNow.Para_u8)
            {
                    ...
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_CLO, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_CLO_CALIB_ZERO, __SET_CLO_CALIB_ZERO, __SET_CLO_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.CLO_Calib_Zero;
                            break;
                ...
                case __SET_CLO_CALIB_SLOPE:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_CLO, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_CLO_CALIB_SLOPE, __SET_CLO_CALIB_ZERO, __SET_CLO_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.CLO_Calib_Slope;
                            break;
                ...
                case __SET_CLO_RESET:
                    ...
                    RS485_LogData_Calib(_RS485_SS_CLO_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
            }
            break;
                    ...
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_CLO, __SET_OFFSET_CLO, __SET_OFFSET_TEMP,
                                               &sButton.Old_value, 0xF2);
                            sButton.Old_value = sParaDisplay.CLO_Offset_i32;
                            break;
                ...
                case __SET_OFFSET_TEMP:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_TEMP, __SET_OFFSET_CLO, __SET_OFFSET_TEMP,
                                               &sButton.Old_value,  0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_OFFSET:
                ...
                {
                    case __SET_OFFSET_CLO:
                      Save_ParamCalib(((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_CLO)), sSensor_CLO.temp_Offset_f);
                      break;
                      
                    case __SET_OFFSET_TEMP:
                      Save_ParamCalib(sSensor_CLO.CLO_Offset_f, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_Temp)));
                      break;
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    ...
                    case __SET_CLO_CALIB_SLOPE:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value < CLO_RANGE_MAX * Calculator_Scale(sParaDisplay.Scale_CLO))
            ...
            case __SET_CLO_CALIB_ZERO:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_CLO, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_CLO_CALIB_ZERO, __SET_CLO_CALIB_ZERO, __SET_CLO_RESET,
                                           &sParaDisplay.CLO_Calib_Zero, 0xF1);
                        sParaDisplay.CLO_Calib_Zero = sButton.Old_value;
                        break;
            ...
            case __SET_CLO_CALIB_SLOPE:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_CLO, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_CLO_CALIB_SLOPE, __SET_CLO_CALIB_ZERO, __SET_CLO_RESET,
                                           &sParaDisplay.CLO_Calib_Slope, 0xF1);
                        sParaDisplay.CLO_Calib_Slope = sButton.Old_value;
                        break;
                ...
                case __SET_OFFSET_CLO:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8-1),
                                               __SET_OFFSET_CLO, __SET_OFFSET_CLO, __SET_OFFSET_TEMP,
                                               &sParaDisplay.CLO_Offset_i32, 0xF1);
                            break;
