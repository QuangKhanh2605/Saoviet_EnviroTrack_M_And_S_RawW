...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_CLO_TITLE,        "CALIB SENSOR",   NULL,   _DTYPE_STRING,   0x00,  NULL,       0,  0,  0x00,    _LCD_SCR_SET_CALIB_SS_CLO},
    {   __SET_CLO_VALUE,        "CLO: ",          NULL,   _DTYPE_I32,      0,  NULL,       2,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_CLO},
    {   __SET_CLO_CALIB_ZERO,   "1.Zero : ",       NULL,   _DTYPE_I32,      0,  " mg/L",    3,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_CLO},
    {   __SET_CLO_CALIB_SLOPE,  "2.Slope: ",       NULL,   _DTYPE_I32,      0,  " mg/L",    4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_CLO},
    {   __SET_CLO_RESET,        "3.Reset",        NULL,   _DTYPE_STRING,   0x00,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_CLO},
...
//    sLCDObject[__SC1_CLO].Scale_u8     = sParaDisplay.Scale_CLO; 
    ...
    sLCDObject[__SET_CLO_VALUE].pData      = &sParaDisplay.CLO_Value_i32;
    sLCDObject[__SET_CLO_VALUE].Scale_u8   = sParaDisplay.Scale_CLO; 

    sLCDObject[__SET_CLO_CALIB_ZERO].pData      = &sParaDisplay.CLO_Calib_Zero; 
    sLCDObject[__SET_CLO_CALIB_ZERO].Scale_u8   = sParaDisplay.Scale_CLO; 
    sLCDObject[__SET_CLO_CALIB_SLOPE].pData     = &sParaDisplay.CLO_Calib_Slope; 
    sLCDObject[__SET_CLO_CALIB_SLOPE].Scale_u8  = sParaDisplay.Scale_CLO; 
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.CLO_Filter_i32 = (int32_t)(sSensor_CLO.CLO_Filter_f * Calculator_Scale(0xFE));
