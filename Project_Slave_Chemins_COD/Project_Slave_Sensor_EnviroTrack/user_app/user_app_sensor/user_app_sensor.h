...
#define RANGE_KEY_MAX           COD_RANGE_MAX
...
typedef enum
{
    _RS485_SS_COD_OPERA = 0,
    _RS485_SS_COD_ZERO,
    _RS485_SS_COD_SLOPE,
    _RS485_SS_TURB_ZERO,
    _RS485_SS_TURB_SLOPE,
    
    _RS485_SS_COD_CALIB_ZERO,
    _RS485_SS_COD_CALIB_SLOPE,
    _RS485_SS_TURB_CALIB_ZERO,
    _RS485_SS_TURB_CALIB_SLOPE,
    _RS485_SS_COD_RESET,
...
typedef struct
{
    ...
    float   COD_Zero_Calib_f;
    float   COD_Slope_Calib_f;
...
extern Struct_Sensor_COD    sSensor_COD;
