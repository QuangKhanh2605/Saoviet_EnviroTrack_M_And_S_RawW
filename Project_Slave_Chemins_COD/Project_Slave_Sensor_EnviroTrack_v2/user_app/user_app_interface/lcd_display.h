...
//    __SC1_TURB,
    ...
    __SET_COD_VALUE,
    __SET_TURB_VALUE,
    __SET_COD_CALIB_ZERO,
    __SET_COD_CALIB_SLOPE,
    __SET_TURB_CALIB_ZERO,
    __SET_TURB_CALIB_SLOPE,
    __SET_COD_RESET,
    
    __SET_COD_TITLE_PLS,
    __SET_COD_VALUE_PLS,
    __SET_TURB_VALUE_PLS,
    __SET_COD_CALIB_P1_PLS,
    __SET_COD_CALIB_P2_PLS,
    __SET_COD_RESET_PLS,
...
typedef struct
{
    ...
    int32_t     COD_Filter_i32;
    int32_t     TURB_Filter_i32;
    int32_t     Temp_Filter_i32;
    
    int32_t     COD_Offset_i32;
    int32_t     TURB_Offset_i32;
    int32_t     temp_Offset_i32;
    
    int32_t     COD_Calib_Zero_i32;
    int32_t     COD_Calib_Slope_i32;
