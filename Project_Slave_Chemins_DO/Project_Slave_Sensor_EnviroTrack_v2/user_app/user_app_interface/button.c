...
//    static uint8_t TempScale = 1;
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_DO_PLS:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_DO_CALIB_P1_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_DO_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_DO_CALIB_P1_PLS, __SET_DO_CALIB_P1_PLS, __SET_DO_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
                ...
                case __SET_DO_CALIB_P2_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_DO_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_DO_CALIB_P2_PLS, __SET_DO_CALIB_P1_PLS, __SET_DO_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
          ...
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_CALIB_SS_DO:
                switch (sLCD.sScreenBack.Para_u8)
                {
                    ...
                    case __SET_DO_CALIB_0:
                      Save_CalibPlus(_E_P_ZERO, 1, 0, 0);
                      break;
            ...
            case _LCD_SCR_SET_CALIB_SS_DO_PLS:
                if(sSensor_DO.State_Measure_DO_u8 == _MEASURE_VALID)
                {
                    On_Speaker(50);
                    sParaDisplay.State_Setting = _STATE_SETTING_DONE;
                    switch (sLCD.sScreenBack.Para_u8)
                    {
                        case __SET_DO_CALIB_P1_PLS:
                          Save_CalibPlus(_E_P_ZERO, 1, 0, 0);
                          Save_CalibPlus(_E_P_PLS1, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_Oxy_MGL)));
                          break;
                          
                        case __SET_DO_CALIB_P2_PLS:
                          Save_CalibPlus(_E_P_ZERO, 1, 0, 0);
                          Save_CalibPlus(_E_P_PLS2, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_Oxy_MGL)));
                          break;
                          
                        case __SET_DO_RESET_PLS:
                          Save_CalibPlus(_E_P_ZERO, 0, 0, 0);
                          Save_CalibPlus(_E_P_PLS1, 0, 0, 0);
                          Save_CalibPlus(_E_P_PLS2, 0, 0, 0);
                          break;
        ...
        case _LCD_SCR_SET_CALIB_SS_DO_PLS:
              if(sLCD.sScreenNow.SubIndex_u8 == 0)
              {
                    if (sLCD.sScreenNow.Para_u8 > sLCD.sScreenNow.ParaMin_u8 ) {
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_DO, 0,
                                               __SET_DO_RESET, __SET_DO_CALIB_100, __SET_DO_RESET,
                                               NULL, 0xF1);
                    }
              }
              else
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    case __SET_DO_CALIB_P1_PLS:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value < OXY_MG_L_RANGE_MAX * Calculator_Scale(sParaDisplay.Scale_Oxy_MGL))
                                    sButton.Old_value+=1;
                                break;
...
void BUTTON_Down_Process (void)
{
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_DO:
              ...
              {
                    if (sLCD.sScreenNow.Para_u8 == sLCD.sScreenNow.ParaMax_u8) {
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_DO_PLS, 0,
                                            __SET_DO_CALIB_P1_PLS, __SET_DO_CALIB_P1_PLS, __SET_DO_RESET_PLS,
                                            NULL, 0xF1);
                    } else {
                        sLCD.sScreenNow.Para_u8++;
