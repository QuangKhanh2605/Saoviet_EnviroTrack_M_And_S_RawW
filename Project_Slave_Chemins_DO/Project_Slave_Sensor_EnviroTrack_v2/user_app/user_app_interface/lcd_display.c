...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_DO_TITLE,     "CALIB SENSOR",     NULL,   _DTYPE_STRING,   0x00,  NULL,       0,  0,  0x00,    _LCD_SCR_SET_CALIB_SS_DO},
    {   __SET_DO_VALUE,     "DO: ",             NULL,   _DTYPE_I32,      0,     " %",       2,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_DO},
    ...
    {   __SET_DO_TITLE_PLS,        "CALIB PLUS",    NULL,   _DTYPE_STRING,   0x00,  NULL,    0,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_DO_PLS},
    {   __SET_DO_VALUE_PLS,        "DO: ",          NULL,   _DTYPE_I32,     0, " mg/L",      2,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_DO_PLS},
    {   __SET_DO_CALIB_P1_PLS,     "1.DO_P1: ",     NULL,   _DTYPE_I32,       0,  " mg/L",   3,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_DO_PLS},
    {   __SET_DO_CALIB_P2_PLS,     "2.DO_P2: ",     NULL,   _DTYPE_I32,       0,  " mg/L",   4,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_DO_PLS},
    {   __SET_DO_RESET_PLS,        "3.Reset",       NULL,   _DTYPE_STRING,   0,  NULL,       5,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_DO_PLS},
    ...
    {   __SET_ALARM_TITLE,      "WARNING DO",      NULL,    _DTYPE_STRING,  0,      NULL,        0,  0, 0x00,    _LCD_SCR_SET_ALARM},
    ...
    {   __SET_RANGE_U_KEY,        "1.U_DO  : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        2,  0, 0x00,    _LCD_SCR_SET_RANGE},
    {   __SET_RANGE_L_KEY,        "2.L_DO  : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        3,  0, 0x00,    _LCD_SCR_SET_RANGE},
...
//    Deinit_LCD12864();
    ...
    sLCDObject[__SET_DO_VALUE_PLS].pData       = &sParaDisplay.Oxy_Mg_L_Value_i32; 
    sLCDObject[__SET_DO_VALUE_PLS].Scale_u8    = sParaDisplay.Scale_Oxy_MGL;
    
    sLCDObject[__SET_DO_CALIB_P1_PLS].pData      = &sParaDisplay.Calib_P1_Pls_i32; 
    sLCDObject[__SET_DO_CALIB_P1_PLS].Scale_u8   = sParaDisplay.Scale_Oxy_MGL;  
    sLCDObject[__SET_DO_CALIB_P2_PLS].pData     = &sParaDisplay.Calib_P2_Pls_i32; 
    sLCDObject[__SET_DO_CALIB_P2_PLS].Scale_u8  = sParaDisplay.Scale_Oxy_MGL;  
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.Calib_P1_Pls_i32   = (int32_t)(sCalibPlus.PPls1.pt_y * Calculator_Scale(sParaDisplay.Scale_Oxy_MGL));
    sParaDisplay.Calib_P2_Pls_i32   = (int32_t)(sCalibPlus.PPls2.pt_y * Calculator_Scale(sParaDisplay.Scale_Oxy_MGL));
}
