...
//    static uint8_t TempScale = 1;
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SETTING:
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NH4, 0,
                                       __SET_NH4_CALIB_ZERO, __SET_NH4_CALIB_ZERO, __SET_NH4_RESET,
                                       NULL, 0xF1);
                    break;
                ...
                case __SCR_SET_OFFSET:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, 0,
                                       __SET_OFFSET_NH4, __SET_OFFSET_NH4, __SET_OFFSET_TEMP,
                                       NULL, 0xF1);
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_NH4:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_NH4_CALIB_ZERO:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NH4, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_NH4_CALIB_ZERO, __SET_NH4_CALIB_ZERO, __SET_NH4_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.NH4_Calib_Zero;
                            break;
                        ...
                        case 1:
                            ...
                            RS485_LogData_Calib(_RS485_SS_NH4_CALIB_ZERO, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_NH4_CALIB_SLOPE:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NH4, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_NH4_CALIB_SLOPE, __SET_NH4_CALIB_ZERO, __SET_NH4_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.NH4_Calib_Slope;
                            break;
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
                                               ...
                                               NULL, 0xF0);
                            Old_Value_i16 = sButton.Old_value;
                            RS485_LogData_Calib(_RS485_SS_NH4_CALIB_SLOPE, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_NH4_RESET:
                    ...
                    RS485_LogData_Calib(_RS485_SS_NH4_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
            }
            break;
                ...
                case __SET_OFFSET_TEMP:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_TEMP, __SET_OFFSET_NH4, __SET_OFFSET_TEMP,
                                               &sButton.Old_value,  0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_OFFSET:
                ...
                {
                    case __SET_OFFSET_NH4:
                      Save_ParamCalib(((float)sButton.Old_value/100), sSensor_NH4.temp_Offset_f);
                      break;
                      
                    case __SET_OFFSET_TEMP:
                      Save_ParamCalib(sSensor_NH4.NH4_Offset_f, ((float)sButton.Old_value/100));
                      break;
            ...
            case __SET_NH4_CALIB_ZERO:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NH4, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_NH4_CALIB_ZERO, __SET_NH4_CALIB_ZERO, __SET_NH4_RESET,
                                           &sParaDisplay.NH4_Calib_Zero, 0xF1);
                        break;
            ...
            case __SET_NH4_CALIB_SLOPE:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NH4, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_NH4_CALIB_SLOPE, __SET_NH4_CALIB_ZERO, __SET_NH4_RESET,
                                           &sParaDisplay.NH4_Calib_Slope, 0xF1);
                        break;
