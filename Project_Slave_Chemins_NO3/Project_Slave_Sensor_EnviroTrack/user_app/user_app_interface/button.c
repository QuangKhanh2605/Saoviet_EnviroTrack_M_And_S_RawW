...
//    static uint8_t TempScale = 1;
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SETTING:
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NO3, 0,
                                       __SET_NO3_CALIB_ZERO, __SET_NO3_CALIB_ZERO, __SET_NO3_RESET,
                                       NULL, 0xF1);
                    break;
                ...
                case __SCR_SET_OFFSET:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, 0,
                                       __SET_OFFSET_NO3, __SET_OFFSET_NO3, __SET_OFFSET_TEMP,
                                       NULL, 0xF1);
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_NO3:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_NO3_CALIB_ZERO:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NO3, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_NO3_CALIB_ZERO, __SET_NO3_CALIB_ZERO, __SET_NO3_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.NO3_Calib_Zero;
                            break;
                        ...
                        case 1:
                            ...
                            RS485_LogData_Calib(_RS485_SS_NO3_CALIB_ZERO, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_NO3_CALIB_SLOPE:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NO3, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_NO3_CALIB_SLOPE, __SET_NO3_CALIB_ZERO, __SET_NO3_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.NO3_Calib_Slope;
                            break;
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
                                               ...
                                               NULL, 0xF0);
                            Old_Value_i16 = sButton.Old_value;
                            RS485_LogData_Calib(_RS485_SS_NO3_CALIB_SLOPE, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_NO3_RESET:
                    ...
                    RS485_LogData_Calib(_RS485_SS_NO3_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
            }
            break;
                    ...
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_NO3, __SET_OFFSET_NO3, __SET_OFFSET_TEMP,
                                               &sButton.Old_value, 0xF2);
                            sButton.Old_value = sParaDisplay.NO3_Offset_i32;
                            break;
                ...
                case __SET_OFFSET_TEMP:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_OFFSET_TEMP, __SET_OFFSET_NO3, __SET_OFFSET_TEMP,
                                               &sButton.Old_value,  0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_OFFSET:
                ...
                {
                    case __SET_OFFSET_NO3:
                      Save_ParamCalib(((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NO3)), sSensor_NO3.temp_Offset_f);
                      break;
                      
                    case __SET_OFFSET_TEMP:
                      Save_ParamCalib(sSensor_NO3.NO3_Offset_f, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_Temp)));
                      break;
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    ...
                    case __SET_NO3_CALIB_SLOPE:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value == 1000)
                                    sButton.Old_value = 10000;
                                break;
            ...
            case __SET_NO3_CALIB_ZERO:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NO3, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_NO3_CALIB_ZERO, __SET_NO3_CALIB_ZERO, __SET_NO3_RESET,
                                           &sParaDisplay.NO3_Calib_Zero, 0xF1);
                        break;
            ...
            case __SET_NO3_CALIB_SLOPE:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_NO3, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_NO3_CALIB_SLOPE, __SET_NO3_CALIB_ZERO, __SET_NO3_RESET,
                                           &sParaDisplay.NO3_Calib_Slope, 0xF1);
                        break;
                ...
                case __SET_OFFSET_NO3:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_OFFSET, (sLCD.sScreenNow.SubIndex_u8-1),
                                               __SET_OFFSET_NO3, __SET_OFFSET_NO3, __SET_OFFSET_TEMP,
                                               &sParaDisplay.NO3_Offset_i32, 0xF1);
                            break;
