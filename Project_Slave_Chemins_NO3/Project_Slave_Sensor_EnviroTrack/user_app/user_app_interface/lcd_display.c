...
sParameter_Display   sParaDisplay = {
    ...
    .Scale_Temp   = 0xFE,
    .NO3_Calib_Zero = 100,
    .NO3_Calib_Slope = 1000,
    .Scale_Alarm  = 0xFF,
    .Scale_Range  = 0xFF,
};

sData   sModelVersion = {(uint8_t *) "SV_ENVI_CM_NO3", 14}; 
...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_NO3_TITLE,        "CALIB SENSOR",   NULL,   _DTYPE_STRING,   0x00,  NULL,       0,  0,  0x00,    _LCD_SCR_SET_CALIB_SS_NO3},
    {   __SET_NO3_VALUE,        "NO3: ",          NULL,   _DTYPE_I32,      0,  NULL,       2,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_NO3},
    {   __SET_NO3_CALIB_ZERO,   "1.Zero : ",       NULL,   _DTYPE_I32,      0,  " mg/L",    3,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_NO3},
    {   __SET_NO3_CALIB_SLOPE,  "2.Slope: ",       NULL,   _DTYPE_I32,      0,  " mg/L",    4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_NO3},
    {   __SET_NO3_RESET,        "3.Reset",        NULL,   _DTYPE_STRING,   0x00,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_NO3},
    
    {   __SET_OFFSET_TITLE, "OFFSET",           NULL,   _DTYPE_STRING,  0,      NULL,       0,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_NO3,   "1.NO3  : ",        NULL,   _DTYPE_I32,     0,   " mg/L",     2,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_TEMP,  "2.Temp : ",        NULL,   _DTYPE_I32,     0,   " ‰C",       3,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    
    {   __SET_ALARM_TITLE,      "WARNING NO3",      NULL,    _DTYPE_STRING,  0,      NULL,        0,  0, 0x00,    _LCD_SCR_SET_ALARM},
    ...
    {   __SET_RANGE_U_KEY,        "1.U_NO3-: ",      NULL,   _DTYPE_I32,  0,      " mg/L",        2,  0, 0x00,    _LCD_SCR_SET_RANGE},
    {   __SET_RANGE_L_KEY,        "2.L_NO3-: ",      NULL,   _DTYPE_I32,  0,      " mg/L",        3,  0, 0x00,    _LCD_SCR_SET_RANGE},
...
//    Deinit_LCD12864();
    ...
    sLCDObject[__SC1_NO3].pData        = &sParaDisplay.NO3_Filter_i32;    
    sLCDObject[__SC1_NO3].Scale_u8     = sParaDisplay.Scale_NO3; 
    sLCDObject[__SC1_TEMP].pData       = &sParaDisplay.Temp_Filter_i32;   
    sLCDObject[__SC1_TEMP].Scale_u8    = sParaDisplay.Scale_Temp; 
    
    sLCDObject[__SET_NO3_VALUE].pData      = &sParaDisplay.NO3_Value_i32;
    sLCDObject[__SET_NO3_VALUE].Scale_u8   = sParaDisplay.Scale_NO3; 

    sLCDObject[__SET_NO3_CALIB_ZERO].pData      = &sParaDisplay.NO3_Calib_Zero; 
    sLCDObject[__SET_NO3_CALIB_ZERO].Scale_u8   = sParaDisplay.Scale_NO3; 
    sLCDObject[__SET_NO3_CALIB_SLOPE].pData     = &sParaDisplay.NO3_Calib_Slope; 
    sLCDObject[__SET_NO3_CALIB_SLOPE].Scale_u8  = sParaDisplay.Scale_NO3; 
    
    sLCDObject[__SET_OFFSET_NO3].pData     = &sParaDisplay.NO3_Offset_i32; 
    sLCDObject[__SET_OFFSET_NO3].Scale_u8  = sParaDisplay.Scale_NO3; 
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.NO3_Value_i32 = (int32_t)(sSensor_NO3.NO3_Value_f * Calculator_Scale(sParaDisplay.Scale_NO3));
    sParaDisplay.Temp_Value_i32 = (int32_t)(sSensor_NO3.temp_Value_f * Calculator_Scale(sParaDisplay.Scale_Temp));
    
    sParaDisplay.NO3_Filter_i32 = (int32_t)(sSensor_NO3.NO3_Filter_f * Calculator_Scale(sParaDisplay.Scale_NO3));
    sParaDisplay.Temp_Filter_i32 = (int32_t)(sSensor_NO3.temp_Filter_f * Calculator_Scale(sParaDisplay.Scale_Temp));
    
    sParaDisplay.NO3_Offset_i32   = (int32_t)(sSensor_NO3.NO3_Offset_f * Calculator_Scale(sParaDisplay.Scale_NO3));
    sParaDisplay.temp_Offset_i32 = (int32_t)(sSensor_NO3.temp_Offset_f * Calculator_Scale(sParaDisplay.Scale_Temp));
