...
#define NO3_RANGE_MAX           1000

#define ALARM_MIN               0
#define ALARM_MAX               NO3_RANGE_MAX

#define RANGE_KEY_MAX           NO3_RANGE_MAX
...
typedef enum
{
    _RS485_SS_NO3_OPERA =0,
    
    _RS485_SS_NO3_CALIB_ZERO,
    _RS485_SS_NO3_CALIB_SLOPE,
    _RS485_SS_NO3_RESET,
...
extern Struct_Sensor_NO3    sSensor_NO3;
