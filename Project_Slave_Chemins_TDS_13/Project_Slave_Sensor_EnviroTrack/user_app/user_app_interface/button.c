    ...
    switch (sLCD.sScreenNow.Index_u8)
    {
            ...
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, 0,
                                       __SET_EC_CALIB_ZERO, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                       NULL, 0xF1);
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_EC:
            switch (sLCD.sScreenNow.Para_u8)
            {
                    ...
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_EC_CALIB_ZERO, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.EC_Value_i32;
                            break;
                        ...
                        case 1:
                            ...
                            RS485_LogData_Calib(_RS485_SS_EC_CALIB_ZERO, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_EC_CALIB_SLOPE:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_EC_CALIB_SLOPE, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.EC_Value_i32;
                            break;
                        ...
                        case 1:
                            ...
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
                                               ...
                                               NULL, 0xF0);
                            Old_Value_i16 = sButton.Old_value;
                            RS485_LogData_Calib(_RS485_SS_EC_CALIB_SLOPE, &Old_Value_i16, sizeof(int16_t));
                            break;
                ...
                case __SET_EC_FACTOR:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_EC_FACTOR, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                               &sButton.Old_value, 0xF2);
                             sButton.Old_value = sParaDisplay.Convert_Factor_EC_i32;
                            break;
                        ...
                        case 1:
                            ...
                            Save_ConvertFactorEC(((float)sButton.Old_value/Calculator_Scale(0xFE)));
                            break;
                ...
                case __SET_EC_RESET:
                    ...
                    RS485_LogData_Calib(_RS485_SS_EC_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
            }
            break;
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_OFFSET:
                ...
                {
                    case __SET_OFFSET_EC:
                      Save_ParamCalib(((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_EC)), sSensor_EC.temp_Offset_f);
                      break;
                      
                    case __SET_OFFSET_TEMP:
                      Save_ParamCalib(sSensor_EC.TDS_Offset_f, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_Temp)));
                      break;
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    ...
                    case __SET_EC_CALIB_SLOPE:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value < TDS_RANGE_MAX)
                                    sButton.Old_value++;
                                break;
            ...
            case __SET_EC_CALIB_ZERO:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_EC_CALIB_ZERO, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                           &sParaDisplay.EC_Calib_Zero, 0xF1);
                        sParaDisplay.EC_Calib_Zero = sButton.Old_value;
                        break;
            ...
            case __SET_EC_CALIB_SLOPE:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_EC_CALIB_SLOPE, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                           &sParaDisplay.EC_Calib_Slope, 0xF1);
                        sParaDisplay.EC_Calib_Slope = sButton.Old_value;
                        break;
            ...
            case __SET_EC_FACTOR:
                switch(sLCD.sScreenNow.SubIndex_u8)
                {
                    ...
                    case 1:
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_EC, (sLCD.sScreenNow.SubIndex_u8-1),
                                           __SET_EC_FACTOR, __SET_EC_CALIB_ZERO, __SET_EC_RESET,
                                           &sParaDisplay.Convert_Factor_EC_i32, 0xF1);
                        break;
