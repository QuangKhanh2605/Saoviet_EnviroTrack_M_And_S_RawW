...
sData   sModelVersion = {(uint8_t *) "SV_ENVI_CM_TDS", 14}; 
...
//          para          name                  value      dtype         scale   unit      row  col      screen
    {   __SC1_TITLE,      "TDS.",           NULL,   _DTYPE_STRING,   0x00,      NULL,      0,  0,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_TDS,         NULL,             NULL,   _DTYPE_I16,      0,     "mg/L",      4,  0,  0x00,      _LCD_SCREEN_1  },
    ...
    {   __SET_EC_VALUE,        "EC : ",          NULL,   _DTYPE_I32,      0,  NULL,       2,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    {   __SET_EC_VALUE_TDS,    "TDS: ",          NULL,   _DTYPE_I32,      0,  NULL,       3,  5,  0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    {   __SET_EC_CALIB_ZERO,   "1.Zero  : ",     NULL,   _DTYPE_I32,      0,  " uS/cm",   4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    {   __SET_EC_CALIB_SLOPE,  "2.Slope : ",     NULL,   _DTYPE_I32,      0,  " uS/cm",   5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    {   __SET_EC_FACTOR,       "3.Factor: ",     NULL,   _DTYPE_I32,      0xFE,  NULL,    6,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    {   __SET_EC_RESET,        "4.Reset",        NULL,   _DTYPE_STRING,   0x00,  NULL,    7,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_EC},
    
    {   __SET_OFFSET_TITLE, "OFFSET",           NULL,   _DTYPE_STRING,  0,      NULL,       0,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_EC,    "1.TDS  : ",         NULL,   _DTYPE_I32,     0,   " mg/L",     2,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_TEMP,  "2.Temp : ",        NULL,   _DTYPE_I32,     0,   " ‰C",       3,  0, 0x00,     _LCD_SCR_SET_OFFSET},
    
    {   __SET_ALARM_TITLE,      "WARNING TDS",      NULL,    _DTYPE_STRING,  0,      NULL,        0,  0, 0x00,    _LCD_SCR_SET_ALARM},
    ...
    {   __SET_RANGE_U_KEY,        "1.U_TDS : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        2,  0, 0x00,    _LCD_SCR_SET_RANGE},
    {   __SET_RANGE_L_KEY,        "2.L_TDS : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        3,  0, 0x00,    _LCD_SCR_SET_RANGE},
...
//    Deinit_LCD12864();
    ...
    sLCDObject[__SC1_TDS].Scale_u8     = sParaDisplay.Scale_EC; 
    sLCDObject[__SC1_TEMP].pData       = &sParaDisplay.Temp_Filter_i32;   
    sLCDObject[__SC1_TEMP].Scale_u8    = sParaDisplay.Scale_Temp; 
    
    sLCDObject[__SET_EC_VALUE].pData      = &sParaDisplay.EC_Value_i32;
    sLCDObject[__SET_EC_VALUE].Scale_u8   = sParaDisplay.Scale_EC; 
    
    sLCDObject[__SET_EC_VALUE_TDS].pData      = &sParaDisplay.TDS_Value_i32;
    sLCDObject[__SET_EC_VALUE_TDS].Scale_u8   = sParaDisplay.Scale_EC; 

    sLCDObject[__SET_EC_CALIB_ZERO].pData      = &sParaDisplay.EC_Calib_Zero; 
    sLCDObject[__SET_EC_CALIB_ZERO].Scale_u8   = sParaDisplay.Scale_EC; 
    sLCDObject[__SET_EC_CALIB_SLOPE].pData     = &sParaDisplay.EC_Calib_Slope; 
    sLCDObject[__SET_EC_CALIB_SLOPE].Scale_u8  = sParaDisplay.Scale_EC; 
    
    sLCDObject[__SET_EC_FACTOR].pData     = &sParaDisplay.Convert_Factor_EC_i32; 
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.TDS_Value_i32 = (int32_t)(sSensor_EC.TDS_Value_f * Calculator_Scale(sParaDisplay.Scale_EC));
    ...
    sParaDisplay.TDS_Filter_i32 = (int32_t)(sSensor_EC.TDS_Filter_f * Calculator_Scale(sParaDisplay.Scale_EC));
    sParaDisplay.Temp_Filter_i32 = (int32_t)(sSensor_EC.temp_Filter_f * Calculator_Scale(sParaDisplay.Scale_Temp));
    
    sParaDisplay.EC_Offset_i32   = (int32_t)(sSensor_EC.TDS_Offset_f * Calculator_Scale(sParaDisplay.Scale_EC));
    ...
    sParaDisplay.Convert_Factor_EC_i32 = (int32_t)(sSensor_EC.ConvertFactor_ECtoTDS * Calculator_Scale(0xFE));
