...
#define ALARM_MIN               0
#define ALARM_MAX               TDS_RANGE_MAX

#define RANGE_KEY_MAX           TDS_RANGE_MAX
...
typedef enum
{
    _RS485_SS_EC_OPERA =0,
    
    _RS485_SS_EC_CALIB_ZERO,
    _RS485_SS_EC_CALIB_SLOPE,
    _RS485_SS_EC_RESET,
