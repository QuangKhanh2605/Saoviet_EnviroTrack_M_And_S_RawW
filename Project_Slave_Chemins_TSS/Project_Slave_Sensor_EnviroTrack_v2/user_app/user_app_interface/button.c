...
//    static uint8_t TempScale = 1;
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_TSS_PLS:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_TSS_CALIB_P1_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TSS_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_TSS_CALIB_P1_PLS, __SET_TSS_CALIB_P1_PLS, __SET_TSS_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
                ...
                case __SET_TSS_CALIB_P2_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TSS_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_TSS_CALIB_P2_PLS, __SET_TSS_CALIB_P1_PLS, __SET_TSS_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_CALIB_SS_TSS:
                ...
                {
                    case __SET_TSS_CALIB_ZERO:
                      Save_CalibPlus(_E_P_ZERO, 1, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)),((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)));
                      break;
                      
                    case __SET_TSS_CALIB_SLOPE:
                      Save_CalibPlus(_E_P_SLOPE, 1, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)),((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)));
            ...
            case _LCD_SCR_SET_CALIB_SS_TSS_PLS:
                if(sSensor_TSS.State_Measure_TSS_u8 == _MEASURE_VALID)
                {
                    On_Speaker(50);
                    sParaDisplay.State_Setting = _STATE_SETTING_DONE;
                    switch (sLCD.sScreenBack.Para_u8)
                    {
                        case __SET_TSS_CALIB_P1_PLS:
                          Save_CalibPlus(_E_P_PLS1, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)));
                          break;
                          
                        case __SET_TSS_CALIB_P2_PLS:
                          Save_CalibPlus(_E_P_PLS2, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_TSS)));
                          break;
        ...
        case _LCD_SCR_SET_CALIB_SS_TSS_PLS:
              if(sLCD.sScreenNow.SubIndex_u8 == 0)
              {
                    if (sLCD.sScreenNow.Para_u8 > sLCD.sScreenNow.ParaMin_u8 ) {
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TSS, 0,
                                               __SET_TSS_RESET, __SET_TSS_CALIB_ZERO, __SET_TSS_RESET,
                                               NULL, 0xF1);
                    }
              }
              else
...
void BUTTON_Down_Process (void)
{
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_TSS:
              ...
              {
                    if (sLCD.sScreenNow.Para_u8 == sLCD.sScreenNow.ParaMax_u8) {
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_TSS_PLS, 0,
                                            __SET_TSS_CALIB_P1_PLS, __SET_TSS_CALIB_P1_PLS, __SET_TSS_RESET_PLS,
                                            NULL, 0xF1);
                    } else {
                        sLCD.sScreenNow.Para_u8++;
