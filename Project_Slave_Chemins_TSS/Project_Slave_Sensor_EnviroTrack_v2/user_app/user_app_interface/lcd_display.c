...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_TSS_TITLE_PLS,        "CALIB PLUS",     NULL,   _DTYPE_STRING,   0x00,  NULL,    0,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_TSS_PLS},
    {   __SET_TSS_VALUE_PLS,        "TSS: ",          NULL,   _DTYPE_I32,      0,   NULL,      2,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_TSS_PLS},
    {   __SET_TSS_CALIB_P1_PLS,     "1.TSS_P1: ",     NULL,   _DTYPE_I32,      0,  " mg/L",    3,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_TSS_PLS},
    {   __SET_TSS_CALIB_P2_PLS,     "2.TSS_P2: ",     NULL,   _DTYPE_I32,      0,  " mg/L",    4,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_TSS_PLS},
    {   __SET_TSS_RESET_PLS,        "3.Reset",        NULL,   _DTYPE_STRING,   0,  NULL,       5,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_TSS_PLS},
    ...
    {   __SET_ALARM_TITLE,      "WARNING TSS",      NULL,    _DTYPE_STRING,  0,      NULL,        0,  0, 0x00,    _LCD_SCR_SET_ALARM},
    ...
    {   __SET_RANGE_U_KEY,        "1.U_TSS : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        2,  0, 0x00,    _LCD_SCR_SET_RANGE},
    {   __SET_RANGE_L_KEY,        "2.L_TSS : ",      NULL,   _DTYPE_I32,  0,      " mg/L",        3,  0, 0x00,    _LCD_SCR_SET_RANGE},
...
//    Deinit_LCD12864();
    ...
    sLCDObject[__SET_TSS_VALUE_PLS].pData    = &sParaDisplay.TSS_Value_i32; 
    sLCDObject[__SET_TSS_VALUE_PLS].Scale_u8 = sParaDisplay.Scale_TSS;
    
    sLCDObject[__SET_TSS_CALIB_P1_PLS].pData      = &sParaDisplay.Calib_P1_Pls_i32;
    sLCDObject[__SET_TSS_CALIB_P1_PLS].Scale_u8   = sParaDisplay.Scale_TSS;
    sLCDObject[__SET_TSS_CALIB_P2_PLS].pData      = &sParaDisplay.Calib_P2_Pls_i32; 
    sLCDObject[__SET_TSS_CALIB_P2_PLS].Scale_u8   = sParaDisplay.Scale_TSS;
...
//    sParaDisplay.TSS_Calib_Slope_i32  = (int32_t)(sSensor_TSS.TSS_Slope_Calib_f * Calculator_Scale(sParaDisplay.Scale_TSS));
    ...
    sParaDisplay.TSS_Calib_Zero_i32   = (int32_t)(sCalibPlus.PZero.pt_y * Calculator_Scale(sParaDisplay.Scale_TSS));
    sParaDisplay.TSS_Calib_Slope_i32  = (int32_t)(sCalibPlus.PSlope.pt_y * Calculator_Scale(sParaDisplay.Scale_TSS));
    ...
    sParaDisplay.Calib_P1_Pls_i32   = (int32_t)(sCalibPlus.PPls1.pt_y * Calculator_Scale(sParaDisplay.Scale_TSS));
    sParaDisplay.Calib_P2_Pls_i32   = (int32_t)(sCalibPlus.PPls2.pt_y * Calculator_Scale(sParaDisplay.Scale_TSS));
}
