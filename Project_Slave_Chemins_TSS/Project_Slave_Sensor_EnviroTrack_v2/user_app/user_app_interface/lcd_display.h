...
typedef enum
{
    ...
    __SET_TSS_TITLE,
    __SET_TSS_VALUE,
    __SET_TSS_CALIB_ZERO,
    __SET_TSS_CALIB_SLOPE,
    __SET_TSS_RESET,
    
    __SET_TSS_TITLE_PLS,
    __SET_TSS_VALUE_PLS,
    __SET_TSS_CALIB_P1_PLS,
    __SET_TSS_CALIB_P2_PLS,
    __SET_TSS_RESET_PLS,
...
typedef struct
{
    ...
    int32_t     TSS_Filter_i32;
    int32_t     Temp_Filter_i32;
    
    int32_t     TSS_Offset_i32;
    int32_t     temp_Offset_i32;
    
    int32_t     TSS_Calib_Zero_i32;
    int32_t     TSS_Calib_Slope_i32;
