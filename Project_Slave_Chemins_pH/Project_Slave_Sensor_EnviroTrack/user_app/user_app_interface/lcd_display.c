...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_PH_CALIB_686, "1.Calib 6.86",     NULL,   _DTYPE_STRING,   0x00,  NULL,       3,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    {   __SET_PH_CALIB_918, "2.Calib 9.18",     NULL,   _DTYPE_STRING,   0x00,  NULL,       4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    {   __SET_PH_CALIB_400, "3.Calib 4.00",     NULL,   _DTYPE_STRING,   0x00,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    {   __SET_PH_RESET,     "4.Reset",          NULL,   _DTYPE_STRING,   0x00,  NULL,       6,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
