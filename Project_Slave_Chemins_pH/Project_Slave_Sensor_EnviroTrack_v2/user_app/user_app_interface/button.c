            ...
            switch (sLCD.sScreenNow.Para_u8)
            {
                ...
                case __SCR_SET_CALIB:
                    ...
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_PH, 0,
                                       __SET_PH_CALIB_686, __SET_PH_CALIB_686, __SET_PH_RESET,
                                       NULL, 0xF1);
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_PH:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_PH_CALIB_686:
                    ...
                    Old_Value_i16 = 0;
                    RS485_LogData_Calib(_RS485_SS_PH_CALIB_686, &Old_Value_i16, sizeof(int16_t));
                    break;
                    
                case __SET_PH_CALIB_918:
                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
                                       __CHECK_STATE_SETTING, __CHECK_STATE_SETTING, __CHECK_STATE_SETTING,
                                       NULL, 0xF0);
                    ...
                    Old_Value_i16 = 0;
                    RS485_LogData_Calib(_RS485_SS_PH_CALIB_918, &Old_Value_i16, sizeof(int16_t));
                    break;
                    
//                case __SET_PH_CALIB_400:
//                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
//                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
//                                       __CHECK_STATE_SETTING, __CHECK_STATE_SETTING, __CHECK_STATE_SETTING,
//                                       NULL, 0xF0);
//                    
//                    Old_Value_i16 = 0;
//                    RS485_LogData_Calib(_RS485_SS_PH_CALIB_400, &Old_Value_i16, sizeof(int16_t));
//                    break;
                ...
                case __SET_PH_RESET:
                    ...
                    Old_Value_i16 = 0;
                    RS485_LogData_Calib(_RS485_SS_PH_RESET, &Old_Value_i16, sizeof(int16_t));
                    break;
        ...
        case _LCD_SCR_SET_CALIB_SS_PH_PLS:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_PH_CALIB_P1_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_PH_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_PH_CALIB_P1_PLS, __SET_PH_CALIB_P1_PLS, __SET_PH_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
                ...
                case __SET_PH_CALIB_P2_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_PH_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_PH_CALIB_P2_PLS, __SET_PH_CALIB_P1_PLS, __SET_PH_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_SET_CALIB_SS_PH:
                ...
                {
                    case __SET_PH_CALIB_686:
                      Save_CalibPlus(_E_P_ZERO, 1, 6.86, 6.86);
                      break;
                      
                    case __SET_PH_CALIB_918:
                      Save_CalibPlus(_E_P_SLOPE, 1, 9.18, 9.18);
                      break;
            ...
            case _LCD_SCR_SET_CALIB_SS_PH_PLS:
                if(sSensor_pH.State_Measure_PH_u8 == _MEASURE_VALID)
                {
                    On_Speaker(50);
                    sParaDisplay.State_Setting = _STATE_SETTING_DONE;
                    switch (sLCD.sScreenBack.Para_u8)
                    {
                        case __SET_PH_CALIB_P1_PLS:
                          Save_CalibPlus(_E_P_PLS1, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_pH)));
                          break;
                          
                        case __SET_PH_CALIB_P2_PLS:
                          Save_CalibPlus(_E_P_PLS2, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_pH)));
                          break;
        ...
        case _LCD_SCR_SET_CALIB_SS_PH_PLS:
              if(sLCD.sScreenNow.SubIndex_u8 == 0)
              {
                    if (sLCD.sScreenNow.Para_u8 > sLCD.sScreenNow.ParaMin_u8 ) {
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_PH, 0,
                                               __SET_PH_RESET, __SET_PH_CALIB_686, __SET_PH_RESET,
                                               NULL, 0xF1);
                    }
              }
              else
                ...
                switch (sLCD.sScreenNow.Para_u8)
                {
                    case __SET_PH_CALIB_P1_PLS:
                        switch(sLCD.sScreenNow.SubIndex_u8)
                        {
                            ...
                            case 1:
                                if(sButton.Old_value < PH_RANGE_MAX * Calculator_Scale(sParaDisplay.Scale_pH))
                                    sButton.Old_value+=1;
                                break;
...
void BUTTON_Down_Process (void)
{
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_PH:
              ...
              {
                    if (sLCD.sScreenNow.Para_u8 == sLCD.sScreenNow.ParaMax_u8) {
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_SET_CALIB_SS_PH_PLS, 0,
                                            __SET_PH_CALIB_P1_PLS, __SET_PH_CALIB_P1_PLS, __SET_PH_RESET_PLS,
                                            NULL, 0xF1);
                    } else {
                        sLCD.sScreenNow.Para_u8++;
