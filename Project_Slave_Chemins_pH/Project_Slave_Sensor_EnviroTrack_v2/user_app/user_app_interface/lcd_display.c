...
sData   sModelVersion = {(uint8_t *) "SV_ENVI_CM_PH", 13}; 
...
//          para          name                  value      dtype         scale   unit      row  col      screen
    ...
    {   __SET_PH_CALIB_686, "1.Calib pH 6.86",     NULL,   _DTYPE_STRING,   0x00,  NULL,       3,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    {   __SET_PH_CALIB_918, "2.Calib pH 9.18",     NULL,   _DTYPE_STRING,   0x00,  NULL,       4,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
//    {   __SET_PH_CALIB_400, "3.Calib 4.00",     NULL,   _DTYPE_STRING,   0x00,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    {   __SET_PH_RESET,     "3.Reset",          NULL,   _DTYPE_STRING,   0x00,  NULL,       5,  0, 0x00,    _LCD_SCR_SET_CALIB_SS_PH},
    
    {   __SET_PH_TITLE_PLS,        "CALIB PLUS",     NULL,   _DTYPE_STRING,   0x00,  NULL,    0,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_PH_PLS},
    {   __SET_PH_VALUE_PLS,        "pH: ",            NULL,   _DTYPE_I32,     0,  NULL,       2,  0,  0x00,       _LCD_SCR_SET_CALIB_SS_PH_PLS},
    {   __SET_PH_CALIB_P1_PLS,     "1.pH_P1: ",     NULL,   _DTYPE_I32,      0,  " mg/L",    3,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_PH_PLS},
    {   __SET_PH_CALIB_P2_PLS,     "2.pH_P2: ",     NULL,   _DTYPE_I32,      0,  " mg/L",    4,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_PH_PLS},
    {   __SET_PH_RESET_PLS,        "3.Reset",        NULL,   _DTYPE_STRING,   0,  NULL,       5,  0, 0x00,        _LCD_SCR_SET_CALIB_SS_PH_PLS},
...
//    Deinit_LCD12864();
    ...
    sLCDObject[__SET_PH_VALUE_PLS].pData       = &sParaDisplay.pH_Value_i32; 
    sLCDObject[__SET_PH_VALUE_PLS].Scale_u8    = sParaDisplay.Scale_pH;
    
    sLCDObject[__SET_PH_CALIB_P1_PLS].pData      = &sParaDisplay.Calib_P1_Pls_i32; 
    sLCDObject[__SET_PH_CALIB_P1_PLS].Scale_u8   = sParaDisplay.Scale_pH;  
    sLCDObject[__SET_PH_CALIB_P2_PLS].pData     = &sParaDisplay.Calib_P2_Pls_i32; 
    sLCDObject[__SET_PH_CALIB_P2_PLS].Scale_u8  = sParaDisplay.Scale_pH;  
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.Calib_P1_Pls_i32   = (int32_t)(sCalibPlus.PPls1.pt_y * Calculator_Scale(sParaDisplay.Scale_pH));
    sParaDisplay.Calib_P2_Pls_i32   = (int32_t)(sCalibPlus.PPls2.pt_y * Calculator_Scale(sParaDisplay.Scale_pH));
}
